...
apt update
apt install -y cage qt6-wayland wlr-randr dbus python3-pyside6.qtcore python3-pyside6.qtgui python3-pyside6.qtwidgets python3-pymupdf fonts-dejavu-core udisks2 udiskie exfatprogs
...
echo "Matthew Reader v5.1 installed. Reboot: sudo reboot"
